...
3. EL ESTADO.md Y LAS TRES FICHAS SON TU MEMORIA: léelos al empezar, actualiza ESTADO.md al
   ...
   nivel de consciencia) en FICHA-AVATAR.md, y los NÚMEROS DEL MERCADO donde se vende (precio
   típico del nicho, ciclo de decisión, cómo paga la gente, plazos que permite la pasarela) en
   FICHA-MERCADO.md (plantillas: PLANTILLA-FICHA-ARTE.md / PLANTILLA-FICHA-AVATAR.md /
   PLANTILLA-FICHA-MERCADO.md) — son cosa juzgada: no se redecide paleta/fuente/modo, ni avatar,
   ni precio/prueba/garantía a mitad de proyecto.
   ⚠️ Estos CUATRO (ESTADO + 3 fichas) son los ÚNICOS artefactos de memoria del proyecto.
...
1C. NUNCA ANUNCIES QUE VAS A HACER ALGO SIMPLE, BÁSICO O MÍNIMO. Está prohibido como
   ...
   **Por qué importa más de lo que parece:** el usuario no puede juzgar si algo "simple" es
   ...
   sesión hago la landing completa; la app interna va en la siguiente"), que es una decisión de
